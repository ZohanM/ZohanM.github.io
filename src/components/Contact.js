...
function Contact(){
    return (
        <Box my={10} mx={{xs: 2, sm: 5, md: 10}} id="contact">
            ...
            >
                ...
                >
                    ...
                    <Typography  component={"a"} href={"mailto:marediya.zohan99@gmail.com"} sx={{fontSize:"1.25rem", color:"primary.main", textDecoration: "none"}}>
                ...
                >
                    ...
                    <List >
                        <ListItem disabledPadding sx={{maxWidth: "fit-content", ml: "auto", mr: "auto"}}>
                            ...
                            >
                                <ListItemText primary="LinkedIn" primaryTypographyProps={{variant: "h5", color: "primary.main"}}/>
                            </Link>
                        </ListItem>
                        <ListItem disablePadding sx={{maxWidth: "fit-content", ml: "auto", mr: "auto"}}
                            ...
                            <Link
                                ...
                                sx={{textDecoration: "none"}}
                            >
                                <ListItemText primary="Github" primaryTypographyProps={{variant: "h5", color: "primary.main"}}/>
                            </Link>
                        </ListItem>
                    </List>
                </Grid>
